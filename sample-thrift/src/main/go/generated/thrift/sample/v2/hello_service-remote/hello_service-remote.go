...
import (
	...
	"generated/thrift/sample/v2"
)

var _ = v2.GoUnusedProtection__
...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  HelloResponse lazyHello(HelloRequest request)")
  fmt.Fprintln(os.Stderr, "  HelloResponse blockingHello(HelloRequest request)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := v2.NewHelloServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "lazyHello":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "LazyHello requires 1 args")
      flag.Usage()
    }
    arg20 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.LazyHello(context.Background(), value0))
    fmt.Print("\n")
    break
  case "blockingHello":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "BlockingHello requires 1 args")
      flag.Usage()
    }
    arg26 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.BlockingHello(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
